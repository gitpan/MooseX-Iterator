# This Makefile is for the MooseX::Iterator extension to perl.
#
...
#     ABSTRACT => q[Iterate over collections]
#     AUTHOR => q[Robert Boone <rlb@cpan.org>]
#     DIR => []
#     DISTNAME => q[MooseX-Iterator]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/MooseX/Iterator.pm
...
TO_INST_PM = lib/MooseX/Iterator.pm \
	lib/MooseX/Iterator/Array.pm \
	lib/MooseX/Iterator/Hash.pm \
	lib/MooseX/Iterator/Meta/Iterable.pm \
	lib/MooseX/Iterator/Role.pm

PM_TO_BLIB = lib/MooseX/Iterator/Hash.pm \
	blib/lib/MooseX/Iterator/Hash.pm \
	lib/MooseX/Iterator/Meta/Iterable.pm \
	blib/lib/MooseX/Iterator/Meta/Iterable.pm \
	lib/MooseX/Iterator/Array.pm \
	blib/lib/MooseX/Iterator/Array.pm \
	lib/MooseX/Iterator.pm \
	blib/lib/MooseX/Iterator.pm \
	lib/MooseX/Iterator/Role.pm \
	blib/lib/MooseX/Iterator/Role.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/MooseX/Iterator.pm $(INST_MAN3DIR)/MooseX::Iterator.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/MooseX/Iterator/Hash.pm blib/lib/MooseX/Iterator/Hash.pm \
	  lib/MooseX/Iterator/Meta/Iterable.pm blib/lib/MooseX/Iterator/Meta/Iterable.pm \
	  lib/MooseX/Iterator/Array.pm blib/lib/MooseX/Iterator/Array.pm \
	  lib/MooseX/Iterator.pm blib/lib/MooseX/Iterator.pm \
	  lib/MooseX/Iterator/Role.pm blib/lib/MooseX/Iterator/Role.pm 
